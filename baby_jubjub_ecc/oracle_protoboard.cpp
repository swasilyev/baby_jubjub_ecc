...
namespace libsnark {
    ...
    oracle_protoboard<FieldT, HashT>::oracle_protoboard(const size_t n):
        ...
        pks_packer.reset(new multipacking_gadget<FieldT>(*this, pks_unpacked, pks_packed, FieldT::capacity(), "pks_packer"));
    ...
    void oracle_protoboard<FieldT, HashT>::generate_r1cs_witness() {
        ...
        assert(pks_packed.get_vals(*this) == libff::pack_bit_vector_into_field_element_vector<FieldT>(pks_unpacked.get_bits(*this)));
    }
}